export const term1Data = [
    {
        title : {
            __html: `<span>[필수]</span> 이용 약관 동의`,
        },
        data: {
            __html: `
                <p>제1조(목적)</p>
...
export const term2Data = [
    {
        ...
        data: {
            ...
            <p>나. 회원 관리</p>
            <p>회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리 인 동의여부 확인, 불만처리 등 민원처리 , 고지사항 전달</p>
