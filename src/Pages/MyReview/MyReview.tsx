import { Bean, MrBottom, MrCircle, MrListContainer, MrListMenu, MrOpenList, MrScript, MrTitle, MrTop, MyReviewWrapper, NoListContainer, NoListSub, NoListTitle } from "./MyReviewStyles";
